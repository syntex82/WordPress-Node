...
export class SeoService implements OnModuleInit {
  ...
  private async initializeDefaultSeoSettings() {
    const seoSettings = [
      { key: 'seo_site_title', value: 'My Website', type: 'string', group: 'seo' },
      { key: 'seo_site_description', value: 'Welcome to my website - your destination for quality content and services.', type: 'string', group: 'seo' },
      { key: 'seo_site_keywords', value: 'website, blog, services, products', type: 'string', group: 'seo' },
      ...
      { key: 'seo_organization_name', value: '', type: 'string', group: 'seo' },
...
${urlEntries}
  ...
  async generateRobotsTxt(baseUrl: string) {
    ...
    return `# Robots.txt generated by WordPress Node CMS
User-agent: *
Allow: /
